...
Original file is located at
    https://colab.research.google.com/drive/1-2cROU3V2OJ2sNqHc8RCyNUH5LMFEtSz
"""
...
data = pd.read_csv('/content/drive/MyDrive/Data Set/Au_nanoparticle_dataset.csv')  # Update path accordingly
